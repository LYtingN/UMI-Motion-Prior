...
Usage:
    from Prior_Recon.Masked_Flow.configs.config_achieve.load_config import config_from_yaml
...
def _build_config(d: dict[str, Any]) -> EEMaskedFlowConfig:
    ...
    top_keys = {
        ...
        "temporal_backbone",
        "dit_residual_gate_init", "dit_mask_invalid_lookahead",
        ...
        "per_frame_noise", "ee_state_dim", "oracle_condition",
